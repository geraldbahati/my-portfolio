...
const WhatsAppIcon = function WhatsAppIcon({
  size = 24,
  className,
}: {
  size?: number;
...
export const NavbarMenuOverlay = function NavbarMenuOverlay({
  isOpen,
  isClosing,
  setIsOpen,
              ...
              <ul className="space-y-4 sm:space-y-6 lg:space-y-8 short:space-y-3 text-center lg:text-left">
                {MENU_ITEMS.map((item, index) => (
                  ...
                  >
                    <AdaptiveLink
                      href={item.href}
                      className="text-white hover:text-primary hover:tracking-[0.1em] text-3xl sm:text-4xl lg:text-6xl xl:text-8xl short:text-5xl font-medium block cursor-pointer transition-[color,background-color,border-color,opacity,transform,box-shadow,filter] duration-300"
              ...
              {SOCIAL_LINKS.map((social, index) => {
                ...
                return (
                  <a
                    ...
                    className={`text-white hover:opacity-70 hover:scale-120 hover:rotate-5 active:scale-90 transition-[color,background-color,border-color,opacity,transform,box-shadow,filter] duration-300 cursor-pointer ${
                      isEntering
